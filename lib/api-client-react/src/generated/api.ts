 ...
 */
export const getDashboardAiInsights = async (dashboardAnalytics: DashboardAnalytics, options?: RequestInit): Promise<DashboardInsightsResponse> => {

  return customFetch<DashboardInsightsResponse>(getGetDashboardAiInsightsUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getGetDashboardAiInsightsMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof getDashboardAiInsights>>, TError,{data: BodyType<DashboardAnalytics>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof getDashboardAiInsights>>, TError,{data: BodyType<DashboardAnalytics>}, TContext> => {

const mutationKey = ['getDashboardAiInsights'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof getDashboardAiInsights>>, {data: BodyType<DashboardAnalytics>}> = (props) => {
          const {data} = props ?? {};

          return  getDashboardAiInsights(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type GetDashboardAiInsightsMutationResult = NonNullable<Awaited<ReturnType<typeof getDashboardAiInsights>>>
    export type GetDashboardAiInsightsMutationBody = BodyType<DashboardAnalytics>
    export type GetDashboardAiInsightsMutationError = ErrorType<unknown>

    /**
 * @summary Generate AI-powered insights from dashboard analytics
 */
export const useGetDashboardAiInsights = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof getDashboardAiInsights>>, TError,{data: BodyType<DashboardAnalytics>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof getDashboardAiInsights>>,
        TError,
        {data: BodyType<DashboardAnalytics>},
        TContext
      > => {
      return useMutation(getGetDashboardAiInsightsMutationOptions(options));
    }
